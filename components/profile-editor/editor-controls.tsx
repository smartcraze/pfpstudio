...
import { Move, Palette, Box } from 'lucide-react'
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-3">
                         <div className="relative flex-1 h-10 rounded-md border shadow-sm overflow-hidden group hover:border-blue-500 transition-colors">
                             ...
                             />
                             {/* Only show picker if we want to override. But user wants to pick theme. */}
                             <input 
                                type="color"
                                value={background.type === 'solid' && !background.id.startsWith('grad') ? background.value : '#ffffff'}
                                onChange={handleColorChange}
                                className="opacity-0 w-full h-full cursor-pointer"
                             />
                             <div className="absolute inset-0 pointer-events-none flex items-center justify-center text-xs font-medium bg-white/50 opacity-0 group-hover:opacity-100 transition-opacity">
